# dataset settings
dataset_type = 'AgrigaiaDataset' 

data_root = '/home/vipra/Thesis/Semantic_Segmentation/data/agrigaia'
...
# Evaluators
val_evaluator = dict(type='IoUMetric', iou_metrics=['mIoU','mDice','mFscore'],classwise=True)
